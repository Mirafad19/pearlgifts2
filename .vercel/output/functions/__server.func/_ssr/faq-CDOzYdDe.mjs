...
function FAQAccordion() {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "space-y-8", children: FAQS.map((section, sectionIdx) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h3", { className: "mb-6 font-display text-2xl text-[var(--plum-deep)]", children: section.category }, void 0, false, {
      fileName: "/app/applet/src/routes/faq.tsx?tsr-split=component",
      lineNumber: 86,
      columnNumber: 11
    }, this),
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "space-y-4", children: section.items.map((item, itemIdx) => {
      const id = `${sectionIdx}-${itemIdx}`;
      const isOpen = openIndex === id;
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("button", { onClick: () => setOpenIndex(isOpen ? null : id), className: "w-full text-left rounded-2xl border border-[var(--plum)]/15 bg-white p-6 shadow-soft transition hover:shadow-luxe hover:border-[var(--plum)]/30", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h4", { className: "font-display text-lg text-[var(--plum-deep)]", children: item.q }, void 0, false, {
            fileName: "/app/applet/src/routes/faq.tsx?tsr-split=component",
            lineNumber: 93,
            columnNumber: 21
          }, this),
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(ChevronDown, { className: `h-5 w-5 shrink-0 text-[var(--gold)] transition-transform duration-300 ${isOpen ? "rotate-180" : ""}` }, void 0, false, {
            fileName: "/app/applet/src/routes/faq.tsx?tsr-split=component",
            lineNumber: 94,
            columnNumber: 21
          }, this)
        ...
        isOpen && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "mt-4 text-[var(--ink)] leading-relaxed", children: item.a }, void 0, false, {
          fileName: "/app/applet/src/routes/faq.tsx?tsr-split=component",
          lineNumber: 96,
          columnNumber: 30
        }, this)
...
function FAQPage() {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(SiteLayout, { children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(PageHeader, { eyebrow: "FAQs", title: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(jsxDevRuntimeExports.Fragment, { children: [
      "Questions about your ",
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("em", { className: "not-italic text-gradient-gold", children: "perfect gift" }, void 0, false, {
        fileName: "/app/applet/src/routes/faq.tsx?tsr-split=component",
        lineNumber: 106,
        columnNumber: 34
      }, this)
      ...
      lineNumber: 105,
      columnNumber: 41
    }, this), description: "Answers to common questions about our process, customization, delivery, and corporate programs. Can't find what you're looking for?" }, void 0, false, {
      fileName: "/app/applet/src/routes/faq.tsx?tsr-split=component",
      lineNumber: 105,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("section", { className: "py-14 md:py-20", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mx-auto max-w-4xl px-5", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(FAQAccordion, {}, void 0, false, {
        fileName: "/app/applet/src/routes/faq.tsx?tsr-split=component",
        lineNumber: 111,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mt-20 rounded-3xl bg-[var(--cream)] p-10 md:p-14 text-center", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h3", { className: "font-display text-2xl md:text-3xl text-[var(--plum-deep)]", children: "Didn't find your answer?" }, void 0, false, {
          fileName: "/app/applet/src/routes/faq.tsx?tsr-split=component",
          lineNumber: 114,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "mt-4 text-[var(--ink)] font-sans", children: "Chat with our team directly — we're here to help with any question, no matter how specific." }, void 0, false, {
          fileName: "/app/applet/src/routes/faq.tsx?tsr-split=component",
          lineNumber: 117,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mt-8 flex flex-wrap justify-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Link, { to: "/contact", className: "inline-flex items-center gap-2 rounded-xl border border-[var(--plum)]/20 px-7 py-3.5 text-sm font-semibold text-[var(--plum-deep)] hover:bg-[var(--plum)]/5 transition-all duration-300", children: [
            "Send an Email ",
